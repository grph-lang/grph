...
extension ArrayValueExpression: RepresentableExpression {
    func build(generator: IRGenerator) throws -> IRValue {
        ...
        // TODO: removing
        _ = try generator.builder.buildCall(generator.module.getOrInsertFunction(named: "grpharr_get", type: FunctionType([PointerType.toVoid, GRPHTypes.integer, PointerType.toVoid], VoidType())), args: [
            arrayRef,
