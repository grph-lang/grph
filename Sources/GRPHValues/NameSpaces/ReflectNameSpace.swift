...
public struct ReflectNameSpace: NameSpace {
    ...
    public var exportedFunctions: [Function] {
        [
            Function(ns: self, name: "callFunction", parameters: [Parameter(name: "funcName", type: SimpleType.string), Parameter(name: "namespace", type: SimpleType.string, optional: true), Parameter(name: "params...", type: SimpleType.mixed, optional: true)], returnType: SimpleType.mixed, varargs: true),
            Function(ns: self, name: "callFunctionAsync", parameters: [Parameter(name: "funcName", type: MultiOrType(type1: SimpleType.string, type2: SimpleType.funcref)), Parameter(name: "params...", type: SimpleType.mixed, optional: true)], returnType: SimpleType.void, varargs: true),
            Function(ns: self, name: "callFuncref", parameters: [Parameter(name: "function", type: SimpleType.funcref), Parameter(name: "params...", type: SimpleType.mixed, optional: true)], returnType: SimpleType.mixed, varargs: true),
            Function(ns: self, name: "callMethod", parameters: [Parameter(name: "methodName", type: SimpleType.string), Parameter(name: "namespace", type: SimpleType.string), Parameter(name: "on", type: SimpleType.mixed), Parameter(name: "params...", type: SimpleType.mixed, optional: true)], returnType: SimpleType.mixed, varargs: true),
            Function(ns: self, name: "callConstructor", parameters: [Parameter(name: "type", type: SimpleType.string), Parameter(name: "params...", type: SimpleType.mixed, optional: true)], returnType: SimpleType.mixed, varargs: true),
