...
struct LegacyCommand: ParsableCommand {
    
    static var configuration: CommandConfiguration {
        CommandConfiguration(commandName: "grph", abstract: "Legacy form of the grph compiler, with no subcommand provided", shouldDisplay: false)
    }
