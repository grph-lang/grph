    ...
    func resolveInstruction(children: [Token]) throws -> ResolvedInstruction? {
        ...
        if children[0].tokenType == .commandName {
            ...
            case "#import", "#using":
                let ns: NameSpace
                let member: Token
                // RESOLVE semantic token: ns, function, method, type
            ...
            case "#requires":
                ...
                // RESOLVE semantic token: keyword [1]
            ...
            case "#compiler":
                ...
                // RESOLVE semantic token: keyword
               ...
               assignment > 0 {
                ...
                if last.tokenType == .curlyBraces { // array modification
                    ...
                    if let assigned = try? resolveExpression(tokens: Array(tokens[..<assignment]), infer: nil) as? AssignableExpression {
                        ...
                        // RESOLVE semantic token: type, variable
                        var offset = 0
                        var global = false
                        var final = false
                ...
                let name: Token
                let offset: Int
                // RESOLVE semantic token: ns, function, method
